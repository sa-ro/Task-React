        ...
        const{userAnswer} = this.state
         return (
             <div>
                ...
                <h2 className={`tit`}>3/6</h2>
                <h2 className={`heading`}>{this.props.Data.questions[2].question}</h2>
               
              
                <div className={`align`}>  {
                            this.props.Data.questions[2].answers.map(a =>
                             ...
                             <div>
                                ...
                                <div style={bg}>
                                    ...
                                    <div style={mystyle}>
                                        ...
                                        <p>{this.props.Data.questions[2].why_answer}</p>
