    ...
    render() {
       ...
       return (
                 <div>
                        ...
                        <h2 className={`tit`}>6/6</h2>
                        <h2 className={`heading`}>{this.props.Data.questions[5].question}</h2>
                        <h2 className={`heading`}>{this.props.Data.questions[5].question_hint}</h2>
                        <div className={`ans-ant`}>{
                            this.props.Data.questions[5].answers.map(a =>
                             ...
                             <div>
                                ...
                                <div style={bg}>
                                    ...
                                    <div style={mystyle}>
                                        ...
                                        <p>{this.props.Data.questions[5].why_answer}</p>
